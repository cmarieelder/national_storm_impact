...
## RPubs URL:  
https://rpubs.com/cmarieelder/national_storm_impact_analysis
...
- You must show all your code for the work in your analysis document. This may make the document a bit verbose, but that is okay. In general, you should ensure that `echo = TRUE`
...
2. In the preview window, click the `Publish` button.
3. Once your document is published to RPubs, you should get a unique URL to that document. **Make a note of this URL** as you will need it to submit your assignment.
...
# References
This project was created for the [Reproducible Research Coursera by John Hopkins University](https://www.coursera.org/learn/reproducible-research).
